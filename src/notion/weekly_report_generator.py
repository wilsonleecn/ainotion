...
1. 在开头标注本周报的日期范围。
2. 总结本周完成的重要事项，每一条需要包含（YYYY.MM.DD）格式的日期标志。
3. 总结尚未完成的工作，每一条需要包含（YYYY.MM.DD）格式的日期标志。若其状态为Waiting for response，则说明正在等待co-worker的后续工作。
4. 文末给出接下来工作重点和行动计划。

格式示例：
（2024.03.25）完成了XXX项目的部署
（2024.03.26）与XXX团队讨论了YYY方案
